 ...
 * Use the [admin_order_page.newInstance] factory method to
 * create an instance of this fragment.
 */
class admin_order_page : Fragment() {
    ...
    override fun onCreateView(
        ...
        val r_v = view.findViewById<RecyclerView>(R.id.admin_order)
        ...
        r_v.layoutManager = LinearLayoutManager(
            view.context,
    ...
    companion object {
         ...
         * @return A new instance of fragment admin_order_page.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            admin_order_page().apply {
